...
namespace Sito.Qr.Web.Client.Pages;
...
public partial class Index
{
    ...
    private async Task StartHubConnection()
    {
        _hubConnection = new HubConnectionBuilder()
            .WithUrl(AppSettings.Value.SignalRHubUrl ?? throw new InvalidOperationException("SignalRHubUrl is not set"))
            .AddJsonProtocol(cfg =>
            {
